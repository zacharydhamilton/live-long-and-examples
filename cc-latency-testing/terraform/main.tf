...
resource "confluent_kafka_topic" "partitions_6" {
    topic_name = "six-partitions"
...
resource "confluent_kafka_topic" "partitions_18" {
    topic_name = "eight-teen-partitions"
    rest_endpoint = confluent_kafka_cluster.main.rest_endpoint
    kafka_cluster {
        id = confluent_kafka_cluster.main.id
    }
...
resource "confluent_kafka_topic" "partitions_54" {
    topic_name = "fifty-four-partitions"
    rest_endpoint = confluent_kafka_cluster.main.rest_endpoint
    kafka_cluster {
        id = confluent_kafka_cluster.main.id
    }
